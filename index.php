					...
					update(){
						...
						if(this.status == 1){ //up
							...
							//set detail location while turing
								...
								&& (this.tlu+this.tld)/2 > this.y-this.speed && (this.tlu+this.tld)/2 < this.y) {
						...
						if(this.status == 2){ //right
							...
							//set detail location while turing
								...
								&& (this.tll+this.tlr)/2 < this.x-this.speed && (this.tll+this.tlr)/2 > this.x) {
