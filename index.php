				...
				class Truck{
					...
					update(){
						...
						if(this.status == 1){ //up
							...
							if(this.turn == 0 && 
							   this.tlu > this.y-this.sizey/2-this.speed){		this.y += (this.tlu-(this.y-this.sizey/2-this.speed)-10);
						...
						if(this.status == 2){ //right
							...
							if(this.turn == 0 && 
							   this.tlr < this.x+this.sizex/2+this.speed){		this.x -= ((this.x+this.sizex/2+this.speed)-this.tlr+10);
						...
						if(this.status == 3){ //down
							...
							if(this.turn == 0 && 
							   this.tld < this.y+this.sizey/2+this.speed){		this.y -= ((this.y+this.sizey/2+this.speed)-this.tld+10);
						...
						if(this.status == 4){ //left
							...
							if(this.turn == 0 && this.dbx != 9 &&
							   this.tll > this.x-this.sizex/2-this.speed){		this.x += (this.tll-(this.x-this.sizex/2-this.speed)-10);
